...
function downloadAsPDF() {
    alert('Download for id '+props.itemid)
} 

function shareAsPDF() {
    alert('Share profile for id '+props.itemid)
} 

function sendEmail() {
    alert('Send email to id '+props.itemid)
} 
</script>
...
<template>
    ...
    <div class="flex grid grid-flow-col justify-stretch pb-3">
        ...
        <button @click="shareAsPDF()" class="p-5 bg-gray-200 rounded-lg mx-1 flex justify-center hover:bg-gray-300" title="Share profile">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                <path fill-rule="evenodd" d="M15.75 4.5a3 3 0 1 1 .825 2.066l-8.421 4.679a3.002 3.002 0 0 1 0 1.51l8.421 4.679a3 3 0 1 1-.729 1.31l-8.421-4.678a3 3 0 1 1 0-4.132l8.421-4.679a3 3 0 0 1-.096-.755Z" clip-rule="evenodd" />
            </svg>
        </button>
        <button @click="sendEmail()" class="p-5 bg-gray-200 rounded-lg mx-1 flex justify-center hover:bg-gray-300" title="Send Email">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
